...
# ----------------------------------------------------
API_HOST = os.getenv("API_HOST", "") # Enter the API_HOST url, like "https://se-demo.domino.tech"
API_KEY = os.getenv("API_KEY", "") # Replace with API_KEY, like "2627b46253dfea3a329b8c5b12348b98d5b3c5ffe6eb02a55f7174561fc8c1c4"
